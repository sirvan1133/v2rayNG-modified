...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/sirvan1133/v2rayNG-modified"
    const val APP_API_URL = "https://api.github.com/repos/sirvan1133/v2rayNG-modified/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/sirvan1133/v2rayNG-modified/master/CR.md"
